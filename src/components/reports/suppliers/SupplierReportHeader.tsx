// Hello Khata OS - Supplier Reports Unified Command Header
// হ্যালো খাতা - সরবরাহকারী রিপোর্টস সমন্বিত কমান্ড হেডার
...
interface SupplierReportHeaderProps {
  dateRange: string;
...
export function SupplierReportHeader({
  dateRange,
  onDateRangeChange,
  selectedBranch,
  onBranchChange,
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      ...
      toast.success(isBangla ? 'সরবরাহকারী বিল ও দেনা আপডেট সম্পন্ন' : 'Supplier bills & payables refreshed');
    }, 600);
  };
  ...
  return (
    <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 pb-2">
      ...
      <div className="flex items-center gap-3.5">
        <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-indigo-500/15 via-indigo-500/10 to-blue-500/5 border border-indigo-500/25 flex items-center justify-center text-indigo-600 dark:text-indigo-400 shadow-xs shrink-0 ring-1 ring-indigo-500/10">
        ...
        <div>
          <div className="flex items-center gap-2 flex-wrap">
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground">
              {isBangla ? 'সরবরাহকারী রিপোর্টস ও ক্রয় অ্যানালিটিক্স' : 'Supplier Reports'}
            </h1>
            <span className="inline-flex items-center gap-1 text-[11px] font-mono font-bold px-2.5 py-0.5 rounded-full bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border border-indigo-500/20">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground font-normal mt-0.5">
            {isBangla
              ? 'ইনভেন্টরি ক্রয়, সরবরাহকারীদের প্রদেয় দেনা, পেমেন্ট সময়সূচি এবং সংগ্রহ আচরণ পর্যালোচনা করুন।'
              : 'Track inventory purchases, supplier payables, settlement aging, and procurement behavior.'}
          </p>
        </div>
      </div>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-56 bg-card border-border rounded-2xl shadow-xl p-1.5">
              ...
              >
                ...
                {dateRange === 'this_month' && <Check className="w-3.5 h-3.5 text-indigo-600" />}
              </DropdownMenuItem>
              <DropdownMenuItem
              ...
              >
                ...
                {dateRange === 'last_month' && <Check className="w-3.5 h-3.5 text-indigo-600" />}
              </DropdownMenuItem>
              <DropdownMenuItem
              ...
              >
                ...
                {dateRange === 'this_quarter' && <Check className="w-3.5 h-3.5 text-indigo-600" />}
              </DropdownMenuItem>
              ...
              >
                ...
                {dateRange === 'this_year' && <Check className="w-3.5 h-3.5 text-indigo-600" />}
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56 bg-card border-border rounded-2xl shadow-xl p-1.5">
            ...
            >
              ...
              <div className="min-w-0">
                <span className="block font-bold text-foreground">{isBangla ? 'সরবরাহকারী এক্সেল লেজার' : 'Supplier Ledger (.xlsx)'}</span>
                <span className="text-[10px] text-muted-foreground block">Full purchase &amp; payables model</span>
              </div>
            </DropdownMenuItem>
            <DropdownMenuItem
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <span className="text-[10px] text-muted-foreground block">Procurement summary statement</span>
              </div>
            </DropdownMenuItem>
            <DropdownMenuSeparator className="bg-border" />
            <DropdownMenuItem
