...
interface PayableAgingChartProps {
  data: PayableAgingData;
  isBangla?: boolean;
}

export function PayableAgingChart({
  data,
  isBangla = false,
}: PayableAgingChartProps) {
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-xs sm:text-sm font-bold text-foreground">
              {isBangla ? "মেয়াদ ভিত্তিক বকেয়া (Outstanding Aging Overview)" : "Outstanding Aging Overview"}
            </h3>
            <p className="text-[11px] text-muted-foreground">
              {isBangla ? "সরবরাহকারীদের কাছে প্রদেয় বকেয়া বিলের বয়সসীমা বিশ্লেষণ" : "Distribution of supplier liabilities by age"}
            </p>
          </div>
        </div>
