...
export function WarehouseDetailsModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="w-[95vw] sm:max-w-3xl max-h-[90vh] overflow-y-auto p-4 sm:p-6 bg-card border-border shadow-2xl space-y-4">
        {/* Modal Header */}
        ...
        {/* Action Header Bar */}
        <div className="flex items-center justify-between gap-2 bg-muted/20 p-2.5 rounded-xl border border-border/60">
          <div className="flex items-center gap-2">
            <Button
              size="sm"
              onClick={() => {
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="products" className="space-y-3 pt-3">
            ...
            <div className="overflow-x-auto border border-border/60 rounded-xl max-h-[320px] overflow-y-auto">
              <table className="w-full text-left text-xs border-collapse min-w-[560px]">
                <thead className="sticky top-0 bg-card z-10">
                  <tr className="bg-muted/60 text-muted-foreground border-b border-border/80 font-semibold uppercase text-[10px]">
          ...
          <TabsContent value="info" className="space-y-4 pt-3">
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 p-3 rounded-lg border border-border/60 bg-muted/20">
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2 text-muted-foreground font-mono">
                  ...
                  <span className="truncate">{warehouse.managerEmail || "N/A"}</span>
                </div>
              </div>
            </div>
