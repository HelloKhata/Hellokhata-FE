    ...
    updatePassword({currentPassword: passwordForm.currentPassword, newPassword: passwordForm.newPassword  }, {
      onSuccess: () => {
        toast({
          ...
          description: isBangla ? 'আপনার পাসওয়ার্ড সফলভাবে পরিবর্তন করা হয়েছে' : 'Your password has been changed successfully',
        });
        setPasswordForm({
          currentPassword: '',
          newPassword: '',
      ...
      onError: (error: any) => {
        toast({
          ...
          description: error?.message || (isBangla ? 'কিছু একটা ভুল হয়েছে' : 'Something went wrong'),
          variant: 'destructive',
        });
      }
    })
